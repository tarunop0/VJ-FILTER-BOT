...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+fx7ngJZDyFlhNTM1')
CHNL_LNK = environ.get('CHNL_LNK','https://t.me/UHD_NETWORK')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'UHD_NETWORK') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://SimonRiley_TaskForce141')
