...
PICS = (environ.get('PICS', 'https://envs.sh/r2Q.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1900118264').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002677910034').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002288558945') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002573356627')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://HDMoviesEarth:unqOY8gUrmDLNXHd@cluster0.0xjypxj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/UHD_NETWORK')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Q4igxofLeKlhOGM1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+fx7ngJZDyFlhNTM1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/SimonRiley_TaskForce141')
